...
`dev-docs/superpowers/specs/2026-06-16-opfs-fts5-coexistence-design.md` の「8. 未確定・後続検討」直前に `## スパイク結果（YYYY-MM-DD）` セクションを追記し、4 項目の実測値と「WAL 変種を使うか」の判断を記録する。

- [ ] **Step 6: Commit**

```bash
git add package.json package-lock.json src/offscreen/opfsSpike.ts dev-docs/superpowers/specs/2026-06-16-opfs-fts5-coexistence-design.md
...
**Files:**
- Modify: `CHANGELOG.md`
- Modify: `dev-docs/superpowers/specs/2026-06-16-opfs-fts5-coexistence-design.md`（スパイク結果が未記入なら）
...
```bash
git add CHANGELOG.md dev-docs/superpowers/specs/2026-06-16-opfs-fts5-coexistence-design.md
