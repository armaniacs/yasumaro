...
**合計: 156 SP | 完了済み: 156 SP (100%) | 未着手: 14 SP**（v6.3.x 以降）

### v6.3.x 候補 PBI

| # | ファイル | 概要 | SP | 優先度 |
|---|---------|------|-----|--------|
| 23 | [2026-06-21-23-fix-privacy-consent-version-migration.md](./2026-06-21-23-fix-privacy-consent-version-migration.md) | プライバシー同意バージョン移行 | 3 | P0 |
| 24 | [2026-06-21-24-feat-db-export-import.md](./2026-06-21-24-feat-db-export-import.md) | `.db` バイナリエクスポート・インポート | 5 | P0 |
| 25 | [2026-06-21-25-feat-opfs-recovery-migration.md](./2026-06-21-25-feat-opfs-recovery-migration.md) | OPFS 復旧時の自動マイグレーション | 5 | P1 |
| 26 | [2026-06-21-26-refactor-sw-modularization-round2.md](./2026-06-21-26-refactor-sw-modularization-round2.md) | Service Worker モジュール分割（第 2 ラウンド） | 3 | P1 |
