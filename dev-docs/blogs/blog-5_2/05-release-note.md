...
# Yasumaro v5.2 をリリースしました

Yasumaro v5.2 を公開しました。
...
開発者向けには [yasumaro](https://github.com/armaniacs/yasumaro) の Releases ページからも入手可能です。
...
- [Yasumaro v5.2 ユーザーガイド](./04-user-guide.md)
