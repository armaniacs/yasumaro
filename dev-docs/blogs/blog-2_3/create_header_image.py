...
def create_header_image():
    ...
    try:
        ...
        ss_preview = Image.open(base_path + "screenshot_preview.png").convert("RGBA")
    ...
    # Preview Screenshot (v2.3 Feature)
    ss_preview_resized = resize_contain(ss_preview, 500, 400)
    ...
    ss_preview_final = add_shadow(ss_preview_resized)
    ...
    # Layout Idea for v2.3:
    # Icon top-left (padding 40)
    # Main SS: Center-Left
    # Preview SS (v2.3 feature): Top-Right
    # Obsidian SS (Result): Bottom-Right
    ...
    preview_x = 650
    preview_y = 50
    img.paste(ss_preview_final, (preview_x, preview_y), ss_preview_final)
    ...
    # Add a title text? "v2.3 Update" if possible?
