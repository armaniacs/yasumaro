...
| [2026-07-25-35-fix-service-worker-state-persistence.md](2026-07-25-35-fix-service-worker-state-persistence.md) | fix | 🔴高 | 🔴あり | 🔶（PBI-29/36と統合実装。`isCacheInitialized`/`autoSavedBadgeTabs`の永続化・テスト完了。実ブラウザ確認残） |
| [2026-07-25-36-refactor-service-worker-singleton-di.md](2026-07-25-36-refactor-service-worker-singleton-di.md) | refactor | 🔴高 | 🔴あり | 🔶（PBI-29と統合実装。`TabCache`の遅延初期化パターン試験導入・テスト完了。実ブラウザ確認残） |
...
| [2026-07-26-29-refactor-service-worker-god-file-split.md](2026-07-26-29-refactor-service-worker-god-file-split.md) | refactor | 🔴高 | 🔴あり | 🔶（オフラインキュー処理抽出・未使用import削除・テスト完了。PBI-36/35と統合して実装。実ブラウザ確認残） |
