...
| PBI | 難易度 | 副作用 | 種別 | 概要 |
|---|---|---|---|---|
| [2026-08-18-03-refactor-tsconfig-strict-flags.md](2026-08-18-03-refactor-tsconfig-strict-flags.md) | 🔴高 | 軽微 | refactor | tsconfig に厳格フラグ3種（noUncheckedIndexedAccess 等）を追加しエディタとCIの型チェックを整合 |
