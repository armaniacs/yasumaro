...
| 8 | [10](2026-07-20-10-feat-offline-network-queue.md) | 8pt | 最大。新機能。最後に実施 |
| 9 | [11](2026-07-20-11-fix-opfs-sqlite-transaction-integrity.md) | 2pt | OPFS/SQLite の整合性強化 |
| 10 | [22](2026-07-20-22-fix-local-ai-pii-masking-order.md) | 2pt | プライバシー改善 |
| 11 | [14](2026-07-20-14-fix-content-script-performance.md) | 3pt | パフォーマンス改善、影響範囲広 |
| 12 | [15](2026-07-20-15-fix-logger-sw-resilience.md) | 3pt | SW ライフサイクル、Logger アーキテクチャ変更 |
| 13 | [16](2026-07-20-16-feat-ai-usage-controls.md) | 3pt | 設定 UI 追加 |
| 14 | [20](2026-07-20-20-fix-external-endpoint-configurability.md) | 3pt | Obsidian/Gemini 設定追加 |
