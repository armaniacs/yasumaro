...
| PBI | 難易度 | 副作用 | 種別 | 概要 |
|---|---|---|---|---|
| [2026-08-18-01-fix-eslint-errors-and-wire-ci-lint.md](2026-08-18-01-fix-eslint-errors-and-wire-ci-lint.md) | 🟡中 | 軽微 | fix | 既存ESLintエラー83件を解消しCI/validateにlintを組み込む |
