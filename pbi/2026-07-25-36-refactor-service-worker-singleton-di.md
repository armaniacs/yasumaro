...
**実装計画**: `dev-docs/plans/2026-07-27-pbi29-36-35-service-worker-refactor-plan.md`（2026-07-27作成。PBI-29・PBI-35と同一ファイル対象のため統合計画。Task 2として本PBIを担当、PBI-29完了後に着手すること）
