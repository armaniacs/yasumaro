  ...
  i18n: {
    getMessage: vi.fn((key: string, substitutions?: Record<string, string>) => {
      const messages: Record<string, string> = {
        ...
        timeMinutesAgo_one: 'N分前',
        timeMinutesAgo_other: 'N分前',
        timeHoursAgo_one: 'N時間前',
        timeHoursAgo_other: 'N時間前',
        timeDaysAgo_one: 'N日前',
        timeDaysAgo_other: 'N日前',
        registeredFilterSources: 'Registered Filter Sources',
        noSourcesRegistered: 'No sources registered',
        loadPreview: 'Load Preview',
        ruleCount: 'Rules: {count}',
        ruleCount_one: 'Rule: {count}',
        ruleCount_other: 'Rules: {count}',
        exceptionCount: 'Exceptions: {count}',
        exceptionCount_one: 'Exception: {count}',
        exceptionCount_other: 'Exceptions: {count}',
        errorCount: 'Errors: {count}',
        errorCount_one: 'Error: {count}',
        errorCount_other: 'Errors: {count}',
        export: 'Export',
        copyToClipboard: 'Copy to Clipboard',
        privacyMode: 'Privacy Mode',
        privacyModeLocalOnly: 'Mode A: Local Only',
        privacyModeLocalOnlyShort: 'Local Only',
        privacyModeLocalOnlyDesc: 'Summarize page content using only local AI, without sending data externally.\nCurrently not supported on most browsers.',
        privacyModeLocalOnlyStatus: '(Under development)',
        privacyModeFullPipeline: 'Mode B: Full Pipeline',
        privacyModeFullPipelineShort: 'Full Pipeline',
        privacyModeFullPipelineDesc: 'Local AI summary → PII masking → Cloud AI refinement.\nCurrently not supported on most browsers.',
        privacyModeFullPipelineStatus: '(Under development)',
        privacyModeMaskedCloud: 'Masked Cloud',
        privacyModeMaskedCloudShort: 'Masked Cloud',
        privacyModeMaskedCloudDesc: 'Send only masked data to cloud AI.\nFor environments where local AI is not available.',
        privacyModeMaskedCloudRecommended: '(Recommended)',
        privacyModeCloudOnly: 'Cloud Only',
        privacyModeCloudOnlyShort: 'Cloud Only',
        privacyModeCloudOnlyDesc: 'Send raw text directly to cloud AI.\nPrioritize speed.',
