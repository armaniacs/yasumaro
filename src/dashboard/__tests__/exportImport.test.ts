...
const { loadPrivacySettings } = await import('../settings/privacySettings.js');
const { loadContentSettings } = await import('../settings/contentSettings.js');
const { loadTrustSettings } = await import('../settings/trustSettings.js');
